...
CODE
close R;
system("unset R_LIBS_USER && \\\n unset R_LIBS && \\\n unset R_LIBS_SITE && \\\n export R_LIBS_USER=\"/usr/local/envs/r_3_5_1/lib/R/library:\$R_LIBS_USER\" && \\\n/usr/local/bin/Rscript $outdir/draw_coverage.R");
system("/usr/bin/convert -density 300 -resize 25% $outdir/$prefix.ReadsCoverage.pdf $outdir/$prefix.ReadsCoverage.png");
