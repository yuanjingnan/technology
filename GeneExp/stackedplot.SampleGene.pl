...
CODE
close R;
#system("$Bin/../software/Rscript3.2.1 $outdir/Expressed_gene_percentage.R");
#system("/ifswh1/BC_PUB/biosoft/pipeline/RNA/RNA_RNAdenovo/RNA_RNAdenovo_2015a/software/R-3.1.1/bin/Rscript $outdir/Expressed_gene_percentage.R");
system("$Bin/Rscript $outdir/Expressed_gene_percentage.R");
system("$Bin/../Bin_CentOS6/convert -density 300 $outdir/Expressed_gene_percentage.pdf $outdir/Expressed_gene_percentage.png");
